      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center relative z-10">
        ...
        <div className="flex items-center space-x-4">
          {user && (
            <>
              {/* Enhanced User Info */}
              <div className="hidden sm:flex items-center space-x-3 px-4 py-2 rounded-xl bg-gradient-to-r from-gray-50/80 to-blue-50/60 border border-gray-200/50 backdrop-blur-sm">
              ...
              <Button
                ...
                className="flex items-center space-x-2 h-10 px-4 bg-white/70 hover:bg-gray-50/80 border-gray-200/60 hover:border-gray-300/80 transition-all duration-200 hover:shadow-md backdrop-blur-sm"
              >
                {isLoggingOut ? (
                  <>
                    <div className="animate-spin rounded-full h-4 w-4 border-2 border-blue-600 border-t-transparent"></div>
                    <span className="hidden sm:inline-block text-sm font-medium">Signing out...</span>
                  </>
                ) : (
                  <>
                    <LogOut className="h-4 w-4 text-gray-600" />
                    <span className="hidden sm:inline-block text-sm font-medium text-gray-700">Sign Out</span>
                  </>
                )}
              </Button>
            </>
